                            ...
                            <div class="container">
                                ...
                                <div class="row justify-content-center">
                                    <div class="col-lg-8 col-xl-7">
                                        <g:form data-sb-form-api-token="API_TOKEN" method="put" controller="user" action="update">
                                            <!-- Pseudo input-->
                                            ...
                                            <div class="form-floating mb-3">
                                                ...
                                                <label for="password2">Validation du Nouveau Password</label>
                                            </div>
                                            <!-- Submit Button-->
                                            <input type="submit" name="incription" value="Valider les Modifications" class="btn btn-primary btn-xl" id="submitButton">
                                        </g:form>
                                    </div>
                                </div>
                            </div>
